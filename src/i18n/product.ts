...
const zhCn: ProductCopy = {
  ...
  paper: { index: '01', kicker: '不发光，也清楚', title: ['不是又一块亮着的屏幕。', '是一张会更新的纸。'], body: '六种实体颜色，用来呈现照片和信息。反射式面板借环境光呈现，不主动发光。刷新结束后，画面会继续保留。', paletteLabel: '六色电子纸色板', pigments: ['墨', '纸', '朱', '黄', '蓝', '绿'] },
  scenes: {
...
const zhTw: ProductCopy = {
  ...
  paper: { ...zhCn.paper, kicker: '不發光，也清楚', title: ['不是又一塊亮著的螢幕。', '是一張會更新的紙。'], body: '六種實體顏色，用來呈現照片和資訊。反射式面板借環境光呈現，不主動發光。更新結束後，畫面會繼續保留。', paletteLabel: '六色電子紙色板', pigments: ['墨', '紙', '朱', '黃', '藍', '綠'] },
...
const ja: ProductCopy = {
  ...
  paper: { index: '01', kicker: '光らなくても、よく見える', title: ['光る画面ではなく、', '変わる一枚の紙。'], body: '6つの実色で写真や情報を描きます。反射型パネルは周囲の光を使い、自ら発光しません。更新後も表示が残ります。', paletteLabel: '6色電子ペーパーパレット', pigments: ['黒', '紙', '赤', '黄', '青', '緑'] },
