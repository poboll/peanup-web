...
const zhCn: ProductCopy = {
  ...
  scenes: {
    ...
    items: [
      ...
      { id: 'branch', number: '02', title: '日常信息', detail: '日期 · 天气 · 书摘', date: '7 月 27 日', weather: '28° / 阵雨', quote: '日子自有它的纹理。', ...localizedCanvas['zh-cn'].branch },
