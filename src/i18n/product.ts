...
const localizedCanvas: Record<Locale, CanvasLabels> = {
  ...
  'zh-cn': {
    ...
    experience: { canvasTitle: '你的画面', canvasSubtitle: '照片或文字', canvasMeta: 'LOCAL PREVIEW' },
  },
  'zh-tw': {
    ...
    experience: { canvasTitle: '你的畫面', canvasSubtitle: '照片或文字', canvasMeta: 'LOCAL PREVIEW' },
  },
  ja: {
...
const en: ProductCopy = {
  ...
  specifications: {
    index: '05', kicker: 'Kickstarter target specifications', title: ['Light to carry.', 'Ready for every day.'], body: 'A 3.68-inch E6 six-color e-paper panel at approximately 258.7 PPI.', targetNote: 'The 3 mm profile, 28 g weight, and one-month-plus battery life are Kickstarter targets, not final production specifications. Battery life varies with refresh frequency.',
    items: [
  ...
  story: { title: ['The charm of Peanut.', 'The energy of Up.'], body: 'Peanup brings the two together. It stays out of the way and keeps one favorite image close.', status: 'Peanup · Coming to Kickstarter' },
...
const zhCn: ProductCopy = {
  ...
  paper: { index: '01', kicker: '不发光，也清楚', title: ['不是又一块亮着的屏幕。', '是一张会更新的纸。'], body: '六种电子纸颜色，用来呈现照片和信息。反射式面板借环境光呈现，不主动发光。刷新结束后，画面会继续保留。', paletteLabel: '六色电子纸色板', pigments: ['墨', '纸', '朱', '黄', '蓝', '绿'] },
  scenes: {
  ...
  hardware: { ...en.hardware, kicker: 'HARDWARE / 默认保持安静', title: ['画面一直在，', '连接只在更新时。'], body: '画面不需要背光。蓝牙只在更新时连接，完成后回到待机。悬浮或轻点，即可查看四项硬件能力。', items: [{ label: '01 / BLE', title: '低功耗蓝牙', short: '短暂连接，随后休息', body: '发送一幅画面后，蓝牙回到低功耗待机。' }, { label: '02 / NFC', title: 'CUID NFC', short: '条件合适时，可作门禁卡', body: '门禁系统支持 CUID 并允许录入时，可以把它用作门禁卡。使用前请先取得管理方授权。' }, { label: '03 / QI', title: 'Qi 无线充电', short: '放下，即可补能', body: '没有外露充电口。放上兼容的 Qi 充电器就能充电。' }, { label: '04 / MAGNET', title: '磁吸摆放', short: '轻轻一吸，画面就位', body: '可以吸在冰箱上，也能搭配兼容的 MagSafe 磁吸配件。MagSafe 兼容不代表 Apple 认证。' }] },
  specifications: { ...en.specifications, index: '05', kicker: 'Kickstarter 目标规格', title: ['足够轻巧，', '也足够完整。'], body: '3.68 英寸 E6 六色电子纸，按有效显示区计算约 258.7 PPI。', targetNote: '3 mm、28 g 和一个月以上续航均为 Kickstarter 目标，并非最终量产规格。续航会随刷新频率变化。', items: [{ value: '3.68” E6', label: '有效面板' }, { value: '≈258.7 PPI', label: '像素密度' }, { value: '6', label: '实体电子纸颜色' }, { value: '3 mm', label: '目标厚度' }, { value: '28 g', label: '目标重量' }, { value: '1 个月以上', label: '目标续航', note: '取决于刷新频率' }, { value: 'BLE', label: '无线传图' }, { value: 'Qi', label: '无线充电' }, { value: '无接口', label: '无外露连接器' }, { value: 'iOS', label: 'App 与快捷指令' }, { value: '微信', label: '小程序传图' }, { value: 'CUID', label: '有条件的 NFC 门禁' }] },
  ...
  story: { title: ['Peanut 的亲切，', '加上 Up 的活力。'], body: '两种感觉放在一起，于是有了 Peanup。它不抢走注意力，只把喜欢的画面留在身边。', status: '花生片 Peanup · 即将登陆 Kickstarter' },
...
const zhTw: ProductCopy = {
  ...
  paper: { ...zhCn.paper, kicker: '不發光，也清楚', title: ['不是又一塊亮著的螢幕。', '是一張會更新的紙。'], body: '六種電子紙顏色，用來呈現照片和資訊。反射式面板借環境光呈現，不主動發光。更新結束後，畫面會繼續保留。', paletteLabel: '六色電子紙色板', pigments: ['墨', '紙', '朱', '黃', '藍', '綠'] },
  ...
  story: { title: ['Peanut 的親切，', '加上 Up 的活力。'], body: '兩種感覺放在一起，於是有了 Peanup。它不搶走注意力，只把喜歡的畫面留在身邊。', status: '花生片 Peanup · 即將登上 Kickstarter' },
...
const ja: ProductCopy = {
  ...
  paper: { index: '01', kicker: '光らなくても、よく見える', title: ['光る画面ではなく、', '変わる一枚の紙。'], body: '6色の電子ペーパー顔料で写真や情報を描きます。反射型パネルは周囲の光を使い、自ら発光しません。更新後も表示を保ちます。', paletteLabel: '6色電子ペーパーパレット', pigments: ['黒', '紙', '赤', '黄', '青', '緑'] },
...
const de: ProductCopy = {
  ...en,
  locale: 'de',
  meta: { title: 'Peanup | 3,68-Zoll-E6-E-Paper mit ≈258,7 PPI', description: 'Peanup ist ein 3,68-Zoll-E6-E-Paper mit sechs Farben und rund 258,7 PPI. Fotos und Alltagsinformationen werden per Bluetooth übertragen und bleiben danach sichtbar.' },
  ...
  paper: { index: '01', kicker: 'Sichtbar, ohne zu leuchten', title: ['Kein weiterer heller Bildschirm.', 'Ein Blatt Papier, das sich ändert.'], body: 'Sechs echte Farben zeigen Fotos und Informationen. Das reflektive Panel nutzt das Umgebungslicht, leuchtet nicht selbst und behält das letzte Bild.', paletteLabel: 'Sechsfarbige E-Paper-Palette', pigments: ['Schwarz', 'Papier', 'Rot', 'Gelb', 'Blau', 'Grün'] },
  ...
  story: { title: ['Der Charme von Peanut.', 'Die Energie von Up.'], body: 'Peanup bringt beides zusammen. Es drängt sich nicht auf und hält ein Lieblingsbild in deiner Nähe.', status: 'Peanup · Demnächst auf Kickstarter' },
...
const fr: ProductCopy = {
  ...
  story: { title: ['Le charme de Peanut.', 'L’énergie d’Up.'], body: 'Peanup réunit les deux. Il reste discret et garde une image préférée près de vous.', status: 'Peanup · Bientôt sur Kickstarter' },
